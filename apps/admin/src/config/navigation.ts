...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Shifts', page: 'shifts', hidden: true },
      { label: 'Roster Calendar', page: 'roster', hidden: true },
      { label: 'Shift Swap Requests', page: 'shift-swap', hidden: true },
      { label: 'Leave Types', page: 'leave-types', hidden: true },
      { label: 'Leave Requests', page: 'leave-requests', hidden: true },
      { label: 'Leave Balance', page: 'leave-balance', hidden: true },
      { label: 'Holiday Calendar', page: 'holidays', hidden: true },
